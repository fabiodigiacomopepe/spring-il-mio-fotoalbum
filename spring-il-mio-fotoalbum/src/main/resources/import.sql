...
INSERT INTO users (first_name, last_name, email, password) VALUES('Fabio', 'Neri', 'fabioneri@gmail.com', '{noop}fabio');
...
INSERT INTO photos (title, description, url, visible, user_id) VALUES('Bear', 'Bear on stream', 'https://img.freepik.com/premium-photo/unique-wild-animals-photography-song-nature-singing-cuties-professional-photo-ai-artwork_997220-5488.jpg', true, 2);
...
INSERT INTO photos (title, description, url, visible, user_id) VALUES('northern Lights', 'Green northern Lights', 'https://i0.wp.com/www.giovannimiele.com/wp-content/uploads/2016/01/islanda-book-fotografico-aurora-boreale.jpg?ssl=1', true, 3);
...
INSERT INTO messages (body, sender_email) VALUES('Ciao ho visto il tuo portfolio, è davvero bello!', 'sararusso@gmail.com');
INSERT INTO messages (body, sender_email) VALUES('Che fotocamera usi?', 'carola34@gmail.com');